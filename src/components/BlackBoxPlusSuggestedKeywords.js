...
export default class BlackBoxPlusSuggestedKeywords extends BlackBoxPlusInfo {


    landmarkDetection() {

        // From https://cloud.google.com/vision/docs/detecting-landmarks#vision_landmark_detection-nodejs
        /**
